...
\begin{IEEEbiographynophoto}{Ziqiang Ma}
 is working toward the PhD degree at Institute of Information Engineering (IIE), Chinese Academy of Sciences (CAS). His current research interests include network and system security.
\end{IEEEbiographynophoto}

% if you will not have a photo at all:
\begin{IEEEbiographynophoto}{Quanwei Cai}
received his PhD degree from Information Security, Institute of Information Engineering (IIE), Chinese Academy of Sciences (CAS). Currently, he is an Assistant Professor at IIE, CAS. His current research interests include applied cryptography and identity management.
\end{IEEEbiographynophoto}
