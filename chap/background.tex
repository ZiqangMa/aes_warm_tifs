...
$$
T_{0}[x] = (2\cdot S(x), S(x), S(x), 3\cdot S(x))  T_{1}[x] = (3\cdot S(x), 2\cdot S(x), S(x), S(x))
$$
$$
T_{2}[x] = (S(x), 3\cdot S(x), 2\cdot S(x), S(x))  T_{3}[x] = (S(x), S(x), 3\cdot S(x), 2\cdot S(x))
$$
...
$$
T_{2}[x] = (2\cdot S(x), S(x), S(x), 3\cdot S(x), 2\cdot S(x), S(x), S(x), 3\cdot S(x))
$$
