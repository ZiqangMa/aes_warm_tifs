...
This attack exploits the relationship between the encryption time and the different input plaintexts( or ciphertexts).
...
\noindent\textbf{Bernstein's attack.}
 This attack is based on the case that the whole AES execution time is correlated with the time for accessing the lookup tables, which depends on input plaintexts\cite{Bernstein2005Cache}.
