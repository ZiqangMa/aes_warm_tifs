...
\subsubsection{Passive Cache Side Channel}
The passive cache side channel means that the attacker cannot impact the cache activities of the victim. 
 Bernstein's attack and internal collision attack belong to this category.

Another type is called trace-driven attack.
