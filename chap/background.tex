...
\hline
$T_{mt}$ & the maximum encryption execution time when all lookup tables are out of caches, i.e. the maximum number of lookup table entries are accessed. \\        % 定义需要再准确一些！
\hline
