...
Random delay \cite{Osvik2006Cache,Page2003Defending}
    or dynamic delay for the constant time of encryption \cite{Askarov2010Predictive,Cock2014The,Ferdinand2004Worst,Zhang2011Predictive}, at the user-space or system level \cite{Yinqian2013D,Cleemput2012Compiler,Coppens2009Practical},
    were designed.
...
The above methods are algorithm-independent and effectively defend against the timing side-channel attacks,
...
Rescheduling the instructions achieves the same goal,
    and is enforced at different levels \cite{jayasinghe2012constant,Page2003Defending, Crane2015Thwarting}.
...
These designs are not implementation-transparent,
