...
One type of cache attack is called trace-driven attack.
...
Another type is called access-driven attack. 
...
Then, the keys are derived from the access patterns.
...
The access-driven attack falls into two categories: synchronous and asynchronous attack \cite{Osvik2006Cache}.
