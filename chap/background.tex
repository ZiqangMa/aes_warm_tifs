...
The straightforward AES implementation needs four 1KB tables, $T_{0}, T_{1}, T_{2}$ and $T_{3}$, as follows,
...
In this paper, we use the compact AES implementation with a 2KB lookup table in RAM.
...
There are similar implementations of other block ciphers:
  table lookup operations and other basic operations,
