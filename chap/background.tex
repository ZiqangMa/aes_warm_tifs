...
In a synchronous Evict+Time attack \cite{Osvik2006Cache,Tromer2010Efficient},
the attacker sets the cache states as follows:
    triggering the encryption to load data into caches
    and explicitly evicting some from caches, of which the addresses will be monitored.
