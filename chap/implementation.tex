...
Figure~\ref{fig:fullwarmworst} shows the distribution of the execution time for $2^{30}$ random plaintexts.
...
We measure the time for different loop number of the \verb+xor+ instruction, by invoking it $10^6$ times with different loop numbers (from 0 to 2000 and the step is 50), as shown in Figure .
