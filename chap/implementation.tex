...
We use the stack switch technique to eliminate the read-write conflict, at the same time it makes the AES execution time much more concentrated as shown in \figurename~\ref{fig:sim}.
 This helps the determination of $T_{nm}$ to be more accurate and reasonable.
...
We repeat the measurement for 10000 times, and calculate the average value of \textcolor[rgb]{1.00,0.00,0.00}{100 greater measurements} as $T_{mm}$.
