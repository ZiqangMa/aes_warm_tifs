...
Cache bank is designed to improve the processor performance by Intel. 
To alleviate the issue, Intel introduced a cache
design consisting of multiple banks. Each of the banks
serves part of the cache line specified by the offset in the
cache line. The banks can operate independently and serve
