...
Then a 4KB lookup table occupies only 32 cache sets and the 2KB stack occupies the other 32 cache sets.
...
Finally, the {\scshape{Warm+Delay}} scheme is ineffective
 ...
 because the attackers change the cache states at any time and observe the cache access pattern during encryption.
