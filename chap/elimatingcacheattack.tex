...
So we perform {\scshape{Delay}} as the last line of defense,
    when the effect of {\scshape{Warm}} is broken and the execution time may leak information on the secret key
