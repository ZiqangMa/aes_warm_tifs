...
\label{sec:goal}
This work aims to investigate the performance of integrating {\scshape{Warm}} and {\scshape{Delay}} to defend against the remote cache timing side-channel attacks,
