...
This section provides a foundation for the analysis of performance optimization in next sections.
...
%So we focus on the situation where large amounts of data are encrypted and then the speed of encryption matters.
  \item In our strategy, the parameters are configurable. Therefore, by configuring appropriate parameters, the optimal performance
...
$T_{mm}$ is defined as the worst execution time for one encryption,
...
\begin{itemize}
  ...
  \item \textbf{Case 3}: The execution time of {\scshape{Encrypt}} is in $[T_{mm}, \infty )$.
