...
However, protected by the {\scshape{Warm+Delay}} scheme,
  any plaintext is processed in the short time (i.e., $T_{NM}$) due to {\scshape{Warm}},
  or done in the long time (i.e., $T_{W}$ or longer) due to system activities after {\scshape{Delay}}.
Therefore, the distribution of the collection depends on non-deterministic system activities,
