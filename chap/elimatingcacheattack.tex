...
Although the execution time of {\scshape{Warm}} may leak the cache state after encryption,
...
Finally, the cache timing side-channel attacks do not work under the integration scheme in Algorithm \ref{alg:aesdefense}.
%
