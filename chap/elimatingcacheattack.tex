...
other cache timing side-channels by active attackers (such as xxxx) are out of the scope of this paper.
...
Then, it provides optimized performance by configuring appropriate parameters
    for different algorithms and computing platforms.
\end{itemize}
...
Our defense scheme focuses on the situation where a mass data are processed.
 A naive scheme can be performing {\scshape{Warm}} and {\scshape{Delay}} every time the protected function is called.
