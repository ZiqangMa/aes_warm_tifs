...
It is concluded that {\scshape{Warm}} should load all lookup tables into caches and  {\scshape{Delay}} should make the execution time to $T_{W}$.
  The optimal performance is achieved by performing {\scshape{Warm}} when cache-miss occurs during the previous execution
    and performing {\scshape{Delay}} when  the execution time of encryption is in $(T_{NM} ,T_{W})$.
