...
In particular,
 {\scshape{Warm}} and  {\scshape{Delay}} are two typical algorithm-independent mechanisms
    ...
    {\scshape{Delay}} inserts padding instructions \emph{after} the encryption operations;\footnote{To perform encryption
     without caches is another choice, and a typical strategy of {\scshape{Delay}} 
     is to finish the encryption operation in the execution time without any caches.}
...
As there are different strategies to apply {\scshape{Warm}} and  {\scshape{Delay}} in the implementation of block ciphers,
  can we find the best way to integrate them into a scheme
