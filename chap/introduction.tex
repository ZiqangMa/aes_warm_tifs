...
We present {\scshape{Warm+Delay}},
   a defense mechanism efficiently based on warm and delay operations which are all algorithm-independent, to eliminate remote cache timing side channels.
