...
These two common mechanisms prevent cache-based timing attacks at different phases,
    but they also introduce extra operations and significantly degrade the performance, especially in naive implementations.
...
This integration scheme does not require any privileged operation on the computer system.
