...
In particular,
 {\scshape{Warm}} and  {\scshape{Delay}} are two typical algorithm-independent mechanisms
    ...
    {\scshape{Delay}} inserts padding instructions \emph{after} the encryption operations;\footnote{To perform encryption
     ...
     Besides, a typical strategy of {\scshape{Delay}}
...
In particular, the measured time reflects either the best case (i.e., all lookup tables are cached),
     or the worst case (i.e., none of tables is in caches).

\item

Prefer {\scshape{Warm}} to {\scshapge{Delay}}, to optimize the performance.
