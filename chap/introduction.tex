...
In fact, our protection scheme produces the optimal performance for various AES implementations (the lookup tables in size of 2K, 4KB, 4.25KB and 5KB) of different key sizes (128, 192 and 256 bits), {\color{red}when $P_{evict} < 0.2$ and $k < 42.41$}.
