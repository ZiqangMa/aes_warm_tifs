...
We apply the optimized integration scheme to AES,
...
It is proven that,
   ...
   achieves the optimal performance with the least extra operations;
    that is, no unnecessary lookup table read operations
   or inserted padding instructions.
%In particular, we apply this scheme to AES, 
%It is found that, 
In commodity computer systems,
 the integration scheme achieves the optimal performance with different key sizes (128, 192, 256 bits)
