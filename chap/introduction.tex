...
In particular,
 {\scshape{Warm}} and  {\scshape{Delay}} are two typical algorithm-independent and implementation-transparent mechanisms
    ...
    and
    {\scshape{Delay}} inserts padding instructions \emph{after} the encryption operations;\footnote{Performing encryption
     always without caches is another choice, but it is very inefficient.
