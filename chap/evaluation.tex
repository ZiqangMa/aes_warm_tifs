...
\textcolor[rgb]{1.00,0.00,0.00}{Note that,
    in the Fig. \ref{pic:sec}, the results is greater than (2 RTDSC), compared with the unprotected ones.
    That is, actually, in the figure the less than $T_{nm} + 2TTT$ or greater than $T_{mm} + 2TTT$.}
