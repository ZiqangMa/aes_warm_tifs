...
In this section,
 we first demonstrate the result that with our scheme the distribution of AES execution time are separated into two parts: less than $T_{nm}$ and no less than $T_{mm}$,
...
\noindent\textbf{The AES distribution with {\scshape{Warm+Delay}} scheme.}
