...
In the analysis of Example 2 in Section \ref{best-strategy-warm}
  \textcolor[rgb]{1.00,0.00,0.00}{As proved in Section~\ref{sec:performanceproof}, the {\scshape{Warm+Delay}} scheme is the optimal.}
...
Fig. \ref{pic:diffscheme} shows that,
    ...
    The {\scshape{Warm+Delay}} scheme has the best performance among all software implementations.
